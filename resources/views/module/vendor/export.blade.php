...
<table class="table" style="table-layout: fixed;">
    <thead>
        <tr>
            ...
            <th style="background-color:#d9d9d9; font-weight: bold; width:215%; text-align: center;">Bidang Usaha</th>
            ...
            <th style="background-color:#d9d9d9; font-weight: bold; width:215%; text-align: center;">Penilaian</th>
    ...
    @foreach($vendors as $vendor)
        ...
        <tr>
            ...
            <td style="vertical-align: middle; word-wrap: break-word;">{{ $vendor['pic_name'] }}</td>
            <td style="vertical-align: middle; word-wrap: break-word;">{{ $vendor['email'] }}</td>
            ...
            <td style="vertical-align: middle; word-wrap: break-word;">{{ $vendor['no_tax'] }}</td>
