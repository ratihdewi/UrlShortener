<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('master.itemcategory.store')}}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-xl-12">
                        <div class="form-group">
                            <label class="small mb-1">Kategori Barang </label><label class="small mb-1" style="color:red">*</label>
                        ...
                        <div class="form-group">
                            ...
                            <input name="code" required="true" value="{{ old('code') }}" class="form-control{{ $errors->has('code') ? ' is-invalid' : '' }}" type="text"/>
                            @if ($errors->has('code'))
                                <span class="small" style="color:red" role="alert">
