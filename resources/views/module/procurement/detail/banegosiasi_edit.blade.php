...
<form action="{{route('procurement.banegosiasi.update', [$spph])}}" method="POST" enctype="multipart/form-data">
@csrf
{{ method_field('PUT') }}
<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLabel">Ubah Berita Acara Negosiasi dan Klarifikasi</h5>
</div>
            ...
            <!-- Account details card-->
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-6">
                            ...
                            <div class="form-group">
                                ...
                                <input name="date" required="true" value="{{ date('Y-m-d', strtotime($spph->negosiasi->date)) }}" class="datepicker form-control{{ $errors->has('date') ? ' is-invalid' : '' }}" placeholder="yyyy-mm-dd" type="text"/>
                                @if ($errors->has('date'))
                            ...
                            <div class="form-group">
                                ...
                                <input name="location" required="true" value="{{ $spph->negosiasi->location }}" class="form-control{{ $errors->has('location') ? ' is-invalid' : '' }}" type="text"/>
                        ...
                        <div class="col-xl-6">
                            ...
                            <div class="form-group">
                                ...
                                <input name="time" required="true" value="{{ $spph->negosiasi->time }}" class="timepicker form-control{{ $errors->has('time') ? ' is-invalid' : '' }}" placeholder="hh:mm" type="time"/>
                                @if ($errors->has('time'))
                                    <span class="small" style="color:red" role="alert">
                            ...
                            <div class="form-group">
                                ...
                                <input name="peserta_eksternal" required="true" value="{{ $spph->negosiasi->peserta_eksternal }}" class="form-control{{ $errors->has('time') ? ' is-invalid' : '' }}" type="text"/>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="form-group">
                                ...
                                <select class="form-control select-edit" name="peserta_id[]" multiple="" style="width:100%">
                                    ...
                                    @forelse($spph->penawarans as $penawaran)
                                        <tr @if($penawaran->can_win == 0) style="color:red" @endif>
                                            <td class="text-center">
                                                <input type="checkbox" @if($penawaran->can_win == 0) disabled="true" @endif @if($penawaran->negosiasi==1) checked @endif name="penawaran_id[]" value="{{$penawaran->id}}"/>
                                            </td>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="form-group">
                                ...
                                <textarea name="meeting_result" rows="4" class="form-control{{ $errors->has('meeting_result') ? ' is-invalid' : '' }}">{{ $spph->negosiasi->meeting_result }}</textarea>
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="form-group">
                                <label class="small mb-1">Ganti Dokumentasi Meeting (.jpg | .png) </label>
                                <input name="photo_doc" value="{{ old('photo_doc') }}" class="form-control{{ $errors->has('photo_doc') ? ' is-invalid' : '' }}" type="file"/>
                        ...
                        <div class="col-xl-6">
                            <div class="form-group">
                                ...
                                (Rp)<input name="negosiasi" required="true" value="{{ $spph->negosiasi->negosiasi }}" class="form-control{{ $errors->has('negosiasi') ? ' is-invalid' : '' }}" type="text"/>
