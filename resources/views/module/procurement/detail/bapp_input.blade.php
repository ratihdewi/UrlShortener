...
<form action="{{route('procurement.bapp.store', [$procurement])}}" method="POST" enctype="multipart/form-data">
@csrf
<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLabel">Input BAPP</h5>
</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            ...
                            <div class="form-group">
                                ...
                                <input name="location" required="true" value="Jakarta" class="form-control{{ $errors->has('location') ? ' is-invalid' : '' }}" type="text"/>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="editor" name="reason" rows="4" class="form-control{{ $errors->has('reason') ? ' is-invalid' : '' }}">{{ old('reason') }}</textarea>
