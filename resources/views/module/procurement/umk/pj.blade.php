                ...
                @else
                    <ul class="list-group">
                      <li class="list-group-item"> 
                        <a href="{{route('procurement.file.download', [$procurement, 'invoice'])}}"> Invoice <i data-feather="download"></i></a>
                      </li>
                      <li class="list-group-item">
                          <a href="{{route('procurement.file.download', [$procurement, 'pj-umk'])}}"> PJUMK <i data-feather="download"></i></a>
                      </li>
                    </ul>
                @endif
            </div>
