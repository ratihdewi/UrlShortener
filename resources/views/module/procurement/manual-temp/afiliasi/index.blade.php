					...
					<form method="POST" id="storeData" enctype="multipart/form-data" action="">
						...
						<nav id="spph-negosiasi">
							...
							<fieldset class="form-group border p-3">
								...
								<table width="190%" class="table mt-5 mb-5" id="tabelItem">
									<thead>
										<tr>
											<th> Negosiasi </th>
											<th> Nama Barang </th>
											...
											@if($procurement->mechanism_id!=3)<th class="inputTextArea"> Nilai <label class="small mb-1" style="color:red">*</label> </th> @endif
										</tr>
									</thead>
								</table>
							</fieldset>
...
@include('module.procurement.manual.afiliasi.js')
